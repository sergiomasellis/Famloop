  ...
  return (
    <div className="w-full max-w-[400px]">
      ...
      <div className="border-4 border-border shadow-[8px_8px_0px_0px_var(--shadow-color)] rounded-xl bg-card overflow-hidden">
        <div className="border-b-4 border-border bg-accent/20 p-6">
          <h2 className="text-3xl font-black uppercase tracking-tight text-foreground">Sign up</h2>
        ...
        <div className="p-6 flex justify-center">
          <SignUp
            ...
            routing="path"
            path="/auth/signup"
            signInUrl={redirectUrl ? `/auth/login?redirect_url=${encodeURIComponent(redirectUrl)}` : "/auth/login"}
            forceRedirectUrl={redirectUrl || "/onboarding/family"}
          />
        </div>
